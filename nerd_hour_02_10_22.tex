...
\visible<2>{\put(230, 100){\includegraphics[height=1.5in]{images/jkepler-PD.jpg}}}
\visible<3>{\put(230, 100){\includegraphics[height=1.5in]{images/galileo-galilei-PD.jpg}}}
\put(-20, 240){\begin{minipage}[t]{0.8 \linewidth}
{
    ``Non-believers" 
        \begin{itemize}
...
\frametitle{4 Common Ways to Find a Planet}
\begin{picture}(320,250) 
\visible<2->{\put(230, 100){\includegraphics[height=1.2in]{images/beta-pictoris-b-FU.jpg}}}
\put(-20, 240){\begin{minipage}[t]{0.8 \linewidth}
{
\begin{enumerate}
    \setcounter{enumi}{2}
...
\begin{picture}(320,250) 
\put(20, 60){\includegraphics[height=2.2in]{images/Rouge_39x27_CMYK-1.jpg}}
\put(180, 60){\includegraphics[height=2.2in]{images/TRAPPIST-1e_LEO_Const_CMYK_Print.jpg}}
\put(60, 230){\begin{minipage}[t]{0.6 \linewidth}
{
