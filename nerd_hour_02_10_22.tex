...
\visible<1-2>{\put(200, 100){\includegraphics[height=1.5in]{images/democritus-PD.jpg}}}
\visible<3>{\put(200, 100){\includegraphics[height=1.5in]{images/plutarch-cc-by-sa4.jpg}}}
...
\frametitle{Antiquity}
\begin{picture}(320,250) 
\visible<1>{\put(200, 100){\includegraphics[height=1.5in]{images/plato-PD.jpg}}}
\visible<2->{\put(200, 100){\includegraphics[height=1.5in]{images/aristotle-PD.jpg}}}
\put(-20, 220){\begin{minipage}[t]{0.6 \linewidth}
{
...
\begin{picture}(320,250) 
\visible<1>{\put(230, 100){\includegraphics[height=1.5in]{images/st-augustine-PD.jpg}}}
\visible<2>{\put(230, 100){\includegraphics[height=1.5in]{images/albertus-magnus-PD.jpg}}}
\visible<3>{\put(230, 100){\includegraphics[height=1.5in]{images/thomas-aquinas-PD.jpg}}}
...
\begin{picture}(320,250) 
%\visible<1>{\put(230, 100){\includegraphics[height=1.5in]{images/nicolaus-copernicus-PD.jpg}}}
\visible<1>{\put(240, 100){\includegraphics[height=1.5in]{images/nicholas_of_cusa-PD.jpg}}}
\visible<2>{\put(240, 100){\includegraphics[height=1.5in]{images/jkepler-PD.jpg}}}
\visible<3>{\put(240, 100){\includegraphics[height=1.5in]{images/galileo-galilei-PD.jpg}}}
...
\begin{picture}(320,250) 
\visible<1>{\put(240, 100){\includegraphics[height=1.5in]{images/lowell-PD.jpg}}}
\visible<2>{\put(240, 100){\includegraphics[height=1.5in]{images/eddington-PD.jpg}}}
\visible<3>{\put(240, 100){\includegraphics[height=1.5in]{images/sagan-PD.png}}}
\put(-20, 240){\begin{minipage}[t]{0.8 \linewidth}
{
    ``Believer" 
        \begin{itemize}
...
\frametitle{Jargon}
\begin{picture}(320,250) 
\visible<2->{\put(10, 60){\includegraphics[height=1.2in]{images/spectra-PD.jpg}}}
\put(-20, 240){\begin{minipage}[t]{0.8 \linewidth}
{
\begin{itemize}
    \item Spectroscopy -
...
\frametitle{4 Common Ways to Find a Planet}
\begin{picture}(320,250) 
\visible<2->{\put(190, 70){\includegraphics[height=2.25in]{images/beta-pictoris-b-FU.jpg}}}
...
\begin{picture}(320,250) 
\visible<1->{\put(200, 100){\includegraphics[height=1.5in]{images/kst-PD.png}}}
...
\begin{picture}(320,250) 
\visible<1->{\put(200, 100){\includegraphics[height=1.2in]{images/TESS-PD.jpg}}}
\put(-20, 240){\begin{minipage}[t]{0.7 \linewidth}
...
\begin{picture}(320,250) 
\visible<1->{\put(200, 100){\includegraphics[height=1.5in]{images/JWST-PD.png}}}
...
\begin{picture}(320,250) 
\visible<1->{\put(200, 100){\includegraphics[height=1.25in]{images/ska-cc-by-3.jpg}}}
\put(-20, 240){\begin{minipage}[t]{0.7 \linewidth}
...
\begin{picture}(320,250) 
\visible<1->{\put(160, 65){\includegraphics[height=1.5in]{images/habitable-zone-FU.jpg}}}
\put(-20, 240){\begin{minipage}[t]{0.7 \linewidth}
{
Habitable Zone : 
\begin{itemize}
...
%\begin{picture}(320,250) 
%\put(10, 100){\includegraphics[width=3.75in]{images/mass-orbit-PD.png}}
%\end{picture}
%\end{frame}
...
\begin{picture}(320,250) 
\visible<1-3>{\put(75, 55){\includegraphics[height=1.7in]{images/exoplanet-size.jpg}}}
\visible<4>{\put(20, 55){\includegraphics[width=3.75in]{images/mass-orbit-PD.png}}}
\put(-20, 240){\begin{minipage}[t]{0.8 \linewidth}
{Stars : 
\begin{itemize}
