...
\frametitle{Antiquity}
\begin{picture}(320,250) 
\put(200, 150){\includegraphics[height=0.75in]{images/plato-PD.jpg}{\scriptsize{Democritus}}}
\put(200, 75){\includegraphics[height=0.75in]{images/aristotle-PD.jpg}{\scriptsize{Plutarch}}}
\put(-20, 200){\begin{minipage}[t]{0.6 \linewidth}
{\begin{itemize}
